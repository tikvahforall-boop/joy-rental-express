...
export const metadata: Metadata = {
  title: "Become a Host | Peak Drive Rentals",
  description:
    "Turn your car into a money maker. List your vehicle on Peak Drive Rentals and earn extra income.",
};
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-neutral-100 mb-8">
              ...
              vehicles on Peak Drive Rentals. List for free and start earning.
            </p>
      ...
      <section className="py-16 bg-gradient-to-br from-neutral-800 to-black text-white">
        <div className="container-page text-center">
          ...
          <p className="text-neutral-100 mb-8 max-w-lg mx-auto">
            Join the Peak Drive Rentals community today. Listing is free and
